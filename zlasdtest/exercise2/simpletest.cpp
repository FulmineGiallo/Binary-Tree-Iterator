...
// void stestStackInt(Stk& stk, int& testnum, int& testerr) {
...
// }
// void stestStackInt(int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
...
//
// template <typename Stk>
// void stestStackFloat(Stk& stk, int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
//   try {
...
// }
// void stestStackFloat(int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
...
//
// template <typename Stk>
// void stestStackString(Stk& stk, int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
//   try {
...
// }
// void stestStackString(int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
...
// }
//
// void stestStack(int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
...
// void stestQueueInt(Que& que, int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
//   try {
...
// }
// void stestQueueInt(int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
...
//
// template <typename Que>
// void stestQueueFloat(Que& que, int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
//   try {
...
// }
// void stestQueueFloat(int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
...
//
// template <typename Que>
// void stestQueueString(Que& que, int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
//   try {
...
// }
// void stestQueueString(int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
...
// }
//
// void stestQueue(int& testnum, int& testerr) {
//   int loctestnum = 0, loctesterr = 0;
